...
5. **Một số thành phần cơ bản.**
    - Hàng, bản ghi, bộ dữ liệu.
    - Khóa.
    - Phụ thuộc hàm.
      - Nếu có một phụ thuộc hàm giữa cột A và cột B trong một bảng dữ liệu cho trước, chúng ta có thể viết A -> B, nghĩa là nếu có giá trị cột A ta có thể xác định giá trị cột B.
    - Lược đồ.
      - Thuật ngữ lược đồ (schema) nghĩa là cấu trúc thiết kế của cơ sở dữ liệu và không có bất kỳ dữ liệu nào trong đó. 
...
2. Dạng chuẩn hóa 1NF.
    - Dạng chuẩn hóa đầu tiên yêu cầu cầu mỗi cột trong bảng chỉ chứa các giá trị không thể phân tách và không có nhóm dữ liệu lặp lại.
3. Dạng chuẩn hóa 2NF.
    ...
    - Để đạt được 2NF, bảng nên được chia thành từng bảng riêng biệt, mỗi thuộc tính phụ thuộc hoàn toàn vào khóa chính.
